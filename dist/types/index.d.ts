...
export declare class RiskError extends Error {
    riskType: 'POSITION_SIZE' | 'DAILY_LOSS' | 'MAX_POSITIONS' | 'VOLATILITY';
    details?: any | undefined;
    constructor(message: string, riskType: 'POSITION_SIZE' | 'DAILY_LOSS' | 'MAX_POSITIONS' | 'VOLATILITY', details?: any | undefined);
}
export declare class ExchangeError extends Error {
    exchange: 'binance' | 'bitkub';
    code?: string | undefined;
    details?: any | undefined;
    constructor(message: string, exchange: 'binance' | 'bitkub', code?: string | undefined, details?: any | undefined);
}
